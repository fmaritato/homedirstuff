...
if main_syntax != 'java' || exists("java_javascript")
  " JAVA SCRIPT
  syn include @htmlJavaScript /usr/local/share/vim/vim60/syntax/javascript.vim
...
if main_syntax != 'java' || exists("java_vb")
  " VB SCRIPT
  syn include @htmlVbScript /usr/local/share/vim/vim60/syntax/vb.vim
  unlet b:current_syntax
...
if main_syntax != 'java' || exists("java_css")
  ...
  syn include @htmlCss /usr/local/share/vim/vim60/syntax/css.vim
  unlet b:current_syntax
